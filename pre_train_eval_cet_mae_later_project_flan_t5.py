...
from model_mae_flan_t5 import CETMAE_project_late_flan_t5
...
if __name__ == '__main__':
    ...
    model = CETMAE_project_late_flan_t5(multi_heads=8,feedforward_dim=2048,trans_layers=6, device=device)
    logger.info("the model is CETMAE_project_late_flan-t5")
